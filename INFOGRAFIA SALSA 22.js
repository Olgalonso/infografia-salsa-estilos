...
lib.ssMetadata = [
		{name:"INFOGRAFIA SALSA 22_atlas_1", frames: [[0,0,1300,1300]]},
		{name:"INFOGRAFIA SALSA 22_atlas_2", frames: [[962,0,500,500],[1464,0,500,500],[962,502,500,500],[1464,502,500,500],[0,0,960,960],[1099,1004,553,388],[597,1506,553,388],[0,962,595,842],[1152,1394,553,388],[597,1004,500,500]]},
		{name:"INFOGRAFIA SALSA 22_atlas_3", frames: [[0,390,300,210],[302,390,300,210],[1110,0,400,406],[1512,0,400,406],[0,0,553,388],[604,390,300,210],[555,0,553,388]]}
];
...
(lib._6544825sinfondo = function() {
	this.initialize(ss["INFOGRAFIA SALSA 22_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.cuencosalsacaleña = function() {
	this.initialize(ss["INFOGRAFIA SALSA 22_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ESTILOSSALSA3 = function() {
	this.initialize(ss["INFOGRAFIA SALSA 22_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/INFOGRAFIA SALSA 22_atlas_1.png", id:"INFOGRAFIA SALSA 22_atlas_1"},
		{src:"images/INFOGRAFIA SALSA 22_atlas_2.png", id:"INFOGRAFIA SALSA 22_atlas_2"},
		{src:"images/INFOGRAFIA SALSA 22_atlas_3.png", id:"INFOGRAFIA SALSA 22_atlas_3"}
	],
	preloads: []
};
